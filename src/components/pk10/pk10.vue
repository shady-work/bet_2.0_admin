          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" v-model="which_trad_rule">
                ...
                <option v-for="(v,k) in trad_list" v-bind:value="k">{{v.trad_name}}{{k}}</option>
              </select>
            </div>
          </div>
          <div class="form-group">
  ...
  export default {
    ...
    methods: {
      ...
      edit_one: function(rule_id) {
        this.$http
          .get(`${this.api}/admin/pk10/user/${rule_id}/edit`)
          .then(function(res) {
            let data = res.data;
            if (data.status == 200) {
              ...
              if(this.trad_url)
              {
                for(let i = 0 ; i < this.trad_list.length;i++)
                {
                  if(this.trad_tokensup == this.trad_list[i].trad_tokensup)
                  {
                    ...
                    this.$set(this,'which_trad_rule',i);
                    break;
                  }
      ...
      do_edit: function() {
        this.$http
          .put(`${this.api}/admin/pk10/user/${this.one_id}`, {
      ...
      {
        this.$http.get(`${this.api}/admin/pk10/tradlist`).then(function(res)
        {
          if(res.data.status == 200)
          {
    ...
    watch:
      {
        ...
        {
          this.trad_list.reverse().reverse();
          if(n == 'xxx')
          {
            this.trad_url = '';
            this.trad_tokensup = '';
