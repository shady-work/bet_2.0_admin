<template>
  <div id="cqssc_history">
    <h4 style="margin-top: 8px;margin-bottom:35px;clear: both;margin-left:10px;" id="top">
      ...
      <el-button type="primary" class="pull-left mr10" @click="get_all_history3()" style="margin-left:670px;">今日
      </el-button>
      <el-button type="info" class="pull-left mr10" @click="get_all_history2()" style="margin-left:750px;">查看以往所有数据
      </el-button>
    ...
    <table class="table table-bordered table-hover table-striped text-center">
      ...
      <tr v-for="(v,k) in history_codes">
        ...
        <td v-else="v.is_lottery == 0">
          <button class="btn btn-primary btn-xs" @click="open_prize(v.expect,v.details.ball_0,k)">手动开奖</button>
        </td>
      </tr>
      </tbody>
    </table>
